# Skill-Text: Reisekostenabrechnung (Claude)

> Wortlaut des Skills aus `.claude/skills/reisekostenabrechnung/SKILL.md`, hier zum Nachlesen.
> Die Begründung der Regeln steht in [reisekosten-ki-skills.md](reisekosten-ki-skills.md).
> Der Ask-ALYF-Skill im Zielsystem trägt denselben Regelsatz.
